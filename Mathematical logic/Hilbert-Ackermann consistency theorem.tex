...
\subsection*{Дефиниция. Хеникова система.}
Една формална систма е \textbf{хеникова}, ако за всяка затворена формула $\exists x A$ на системата, съществува затворен терм $t$, такъв че $\exists x A \implies A_x[t]$ е теорема на системата. \newline\newline
...
\subsection*{Дефиниция. Специални константи. Специални аксиоми}
...
Нека $\vdash_F$ $T$ и нека $T'$ е затворен частен случай на $T$. \newline Ще покажем, че $T'$ е тавтологично следствие на затворени частни случаи на аксиомите и специалните аксиоми. Ще направим индукция по дължината на извода в $F$.
\begin{itemize}
	\item[1.] 1 случай:
\end{itemize}
